...
function FeaturedCard({ item }: { item: FeedItem }) {
  return (
    <NavLink className="group lg:col-span-4" href={hrefFor(item)}>
      ...
      <h3 className="mt-2 line-clamp-2 font-medium font-title text-2xl text-foreground tracking-tight group-hover:underline">
...
export function LatestContentPreview() {
  ...
  return (
    <>
      <div className="mb-8">
        <h2 className="font-medium font-title text-3xl text-foreground tracking-tight">
          Featured
        </h2>
      </div>
