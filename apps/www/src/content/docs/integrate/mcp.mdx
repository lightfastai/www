...
- [View hosted OAuth MCP source on GitHub](https://github.com/lightfastai/lightfast/tree/main/apps/mcp)
- [View local stdio MCP source on GitHub](https://github.com/lightfastai/lightfast/tree/main/core/mcp)
